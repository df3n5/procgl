...
public class WhiteTriangleExample extends AbstractGwtGLExample {
	...
	private void initVertexBuffer() {
		...
		float[] vertices = new float[] { 0.0f, 1.0f, 0.0f, // x y z des ersten
				// Dreieckpunktes
				-1.0f, -1.0f, 0.0f, // x y z des zweiten Dreieckpunktes
				1.0f, -1.0f, 0.0f // x y z des dritten Dreieckpunktes
		};
	...
	private void initProjectionMatrix() {
		projectionMatrix = MatrixUtil.createPerspectiveMatrix(45, 1.0f, 0.0f, 100);
	}

...
public class Camera implements MouseMoveHandler, 
	...
	private void handleKeys() {
        ...
        if(currentlyPressedKeys[KeyCodes.KEY_PAGEUP]) {
        	yPos += 1.0f;
        }
        if(currentlyPressedKeys[KeyCodes.KEY_PAGEDOWN]) {
        	yPos -= 1.0f;
        }
        
        if(currentlyPressedKeys[KeyCodes.KEY_ENTER]) {
        	BumpMappingDemo.INSTANCE.removeCeiling();
        }
	}
